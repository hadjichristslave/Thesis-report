...
\begin{figure}
\begin{tabular}{cc}
  \includegraphics[width=60mm]{robotPictures/experiment1/input} &   \includegraphics[width=100mm]{robotPictures/experiment1/clustersWithData} \\
(a) Input  & (b) Pointcloud along with landmarks\\[6pt]
 \includegraphics[width=60mm]{robotPictures/experiment2/depthinput} &   \includegraphics[width=100mm]{robotPictures/experiment2/clustered} \\
