...
The limits of the technique will be analyzed in this section. Firstly restrictions introduced by the sampler will be givnen and secondly decisions related to the decision boundary will be enumerated.

\susbusbsection{Clustering layer}

In the clustering layer

\susbusbsection{Decision layer}
