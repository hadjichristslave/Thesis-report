...
In order to define the model, two major components of the algorithm must be explicitly defined. The data distribution and the SMC sampler. Once these two modules are defined the model can be formally presented.
