...
Once this cloud was acquired, it was reduced and then the reduced cloud along with the meta-information computed in the pipeline were given as input to the sampler. The sampler then outputs clusters of the structure that encapsulate positional, angular and colour information. The results can be seen in  figure Fig.\ref{pcl:post}

The tables following depict the distances between the clustes shown in the picture. Positional distances among neighbor clusters are small, but angular distances do not coincide.
