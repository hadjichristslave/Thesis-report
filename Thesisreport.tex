...
On the other hand, having downsampling operations run with a very high threshold will lead to a very small cloud that has a very small amount of information the inital cloud carried. This will lead to very simplistic results after the clustering that do not contain significant information regarding the cloud.
...
The first figure displays a cloud that has a minimal amount of points removed during the downsampling operations. The sampler will then receive a cloud with a lot of the initial information still contained in its structure.
The second figure displays a cloud that has keept a very small portion of the points the initial cloud carried. The information loss on clean datasets such as this is not significant but plays a significant role in noise-rich data such as data taken from kinect readings while mapping.
