...
\begin{tabular}{c}
 ...
 to the sampler. Top right and bottom ones show the distributions infered for the data. \\[6pt]
\end{tabular}
...
\begin{tabular}{c}
 ...
 (b) Downsampling and clustering results. Top left picture shows the cloud that is given as input\\
 to the sampler. Top right and bottom ones show the distributions infered for the data. \\[6pt]\end{tabular}
...
\begin{center} 
    ...
    \hline
     LandmarkId & GausKL & GausWes & ExpHel & ExpHel & CatKL \\
     \hline
