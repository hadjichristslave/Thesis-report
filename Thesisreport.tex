...
\subsection{Dirichlet Distribution sampling methods}
One of the most natural questions to ask for every distribution is how to generate samples from it. Two basic sampling methods from the Dirichlet Distribution will be presented: Stick breaking process, and Polya's urn.
...
\begin{wrapfigure}{l}{.73\textwidth}
    \includegraphics[width=.61\textwidth]{generalPolya2}
    \caption{GPU}
    \label{generalPolya}
\end{wrapfigure}
